...
const useMeasure = () => {
  ...
  // main function
  // async function main(video, canvasElement) {
  //   const ctx = canvasElement.getContext("2d");
  ...
  // async function drawFaces(video, ctx) {
  //   setPepare(false);
  //   setMeasuring(true);
