...
const rmssd = document.getElementsByClassName("rmssd")[0];
const sdnn = document.getElementsByClassName("sdnn")[0];
const hr = document.getElementsByClassName("hr")[0];

const ctx = canvasElement.getContext("2d");
const ctx2 = canvasElement2.getContext("2d");
const graph = document.getElementsByClassName("graphdiv2")[0];
const graph2 = document.getElementsByClassName("graphdiv")[0];
