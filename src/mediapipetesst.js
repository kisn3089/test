...
function updateChart(times, freq, data) {
  ...
  document.getElementById("cameraFPS").innerHTML =
    "Camera Average FPS: " + Math.round(curPollFreq);

  power = Array.from(data).map((elem, index) => [freq[index] * 60, elem]);

  new Dygraph(document.getElementById("graphdiv"), power, {
...
function updateChart2(data) {
  ...
  new Dygraph(document.getElementById("graphdiv2"), indexedData, {
