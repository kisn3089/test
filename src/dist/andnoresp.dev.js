...
var canvasElement = document.getElementsByClassName("output_canvas")[0]; // const canvasElement2 = document.getElementsByClassName("output_canvas2")[0];
...
var facepred; // const lottie = document.getElementsByClassName("lottie-player")[0];
...
var ctx = canvasElement.getContext("2d"); // const ctx2 = canvasElement2.getContext("2d");
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          canvasElement.height = videoHeight / 2; // start prediction loop
...
function drawFaces() {
  var face_oval, left_eye, right_eye, lips, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, face, mesh, i, _i, _i2, _i3, _i4, _i5, _i6, faceRegion, faceSrc, faceScaled, rgbData, textArr, _i7, blob, form, signature, options;
        ...
        case 0:
          ...
          for (_iterator = curFaces[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (face.faceInViewConfidence > 0.5) {
              ...
              for (i = 0; i < _face_mesh.FACEMESH_FACE_OVAL.length; i++) {
                face_oval.push(_face_mesh.FACEMESH_FACE_OVAL[i][0], _face_mesh.FACEMESH_FACE_OVAL[i][1]);
              }

              for (_i = 0; _i < _face_mesh.FACEMESH_RIGHT_EYE.length; _i++) {
                right_eye.push(_face_mesh.FACEMESH_RIGHT_EYE[_i][0], _face_mesh.FACEMESH_RIGHT_EYE[_i][1]);
              }

              for (_i2 = 0; _i2 < _face_mesh.FACEMESH_LEFT_EYE.length; _i2++) {
                left_eye.push(_face_mesh.FACEMESH_LEFT_EYE[_i2][0], _face_mesh.FACEMESH_LEFT_EYE[_i2][1]);
              }

              for (_i3 = 0; _i3 < _face_mesh.FACEMESH_LIPS.length; _i3++) {
                lips.push(_face_mesh.FACEMESH_LIPS[_i3][0], _face_mesh.FACEMESH_LIPS[_i3][1]);
              }
              ...
              for (_i4 = 0; _i4 < left_eye.length; _i4++) {
                ctx.lineTo(mesh[left_eye[_i4]][0], mesh[left_eye[_i4]][1]);
              }
              ...
              for (_i5 = 0; _i5 < right_eye.length; _i5++) {
                ctx.lineTo(mesh[right_eye[_i5]][0], mesh[right_eye[_i5]][1]);
              }
              ...
              for (_i6 = 0; _i6 < lips.length; _i6++) {
                ctx.lineTo(mesh[lips[_i6]][0], mesh[lips[_i6]][1]);
              }
              ...
              faceSrc = cv.matFromImageData(faceRegion);
              faceScaled = new cv.Mat();
              cv.resize(faceSrc, faceScaled, new cv.Size(32, 32), 0, 0, cv.INTER_NEAREST);
              rgbData = cv.mean(faceScaled); // Get FPS of this loop as well
              ...
              if (mean_red.length > maxHistLen) {
                ...
                for (_i7 = 0; _i7 < maxHistLen; _i7++) {
                  textArr.push("".concat(timingHist[_i7], "\t").concat(mean_red[_i7], "\t").concat(mean_green[_i7], "\t").concat(mean_blue[_i7]));
                }
